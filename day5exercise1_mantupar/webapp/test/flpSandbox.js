		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbptday5exercise1mantupar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbptday5exercise1mantupar-display": {
								"semanticObject": "zbptday5exercise1mantupar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbpt.day5exercise1mantupar",
									"url": sap.ui.require.toUrl("zbpt/day5exercise1mantupar")
								}
							}
						}
					}
